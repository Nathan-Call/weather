...
The web app uses ZIP code data from GeoNames https://www.geonames.org/ and it actively calls weather data from the National Weather Service API https://www.weather.gov/
